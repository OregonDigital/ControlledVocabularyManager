...
RSpec.describe VocabulariesController do
  ...
  describe "PATCH 'update'" do
    ...
    before do
      ...
      allow(vocabulary).to receive(:blocklisted_language_properties).and_return(%i[id issued modified is_replaced_by date same_as is_defined_by])
  ...
  describe 'POST create' do
    ...
    before do
      ...
      allow(vocabulary_form).to receive(:is_valid?).and_return(true)
      allow(vocabulary).to receive(:blocklisted_language_properties).and_return(%i[id issued modified])
