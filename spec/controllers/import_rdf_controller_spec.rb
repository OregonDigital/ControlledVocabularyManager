...
RSpec.describe ImportRdfController, type: :controller do
  ...
  describe "GET 'index'" do
    context 'when logged out' do
      ...
      it 'does not create the ImportForm' do
    ...
    context 'when logged in' do
      ...
      it 'assigns the new form for the view to use' do
        get :index
    ...
    context 'when logged in' do
      ...
      context 'and the form saves' do
        ...
        context 'and the form is requesting a preview' do
          ...
          it 'assigns terms and vocabulary' do
  ...
  describe "GET 'load'" do
    context 'when logged out' do
      ...
      it 'does not create the LoadForm' do
    ...
    context 'when logged in' do
      ...
      it 'renders the load template' do
        get :load
