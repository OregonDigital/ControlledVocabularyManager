...
RSpec.describe ControlledVocabManager::IsoLanguageTranslator do
  ...
  describe '#language_list' do
    context 'When requesting a list with symbol access' do
      it 'returns a list of ISO_639 languages with symbol access' do
    ...
    context 'When requesting a list with no args' do
      it 'defaults to symbol access' do
  ...
  describe '#find_by_name' do
    it 'returns a symbol for the language name' do
  ...
  describe '#sorted_language_list' do
    it 'returns a sorted list of the language hash' do
  ...
  describe '#find_by_symbol' do
    it 'returns a string for the language symbol' do
